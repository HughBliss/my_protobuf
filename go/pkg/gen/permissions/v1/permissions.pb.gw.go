...
func RegisterPermissionsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PermissionsServiceServer) error {
	mux.Handle(http.MethodGet, pattern_PermissionsService_GetAllPermissions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/some.auth.permissions.PermissionsService/GetAllPermissions", runtime.WithHTTPPathPattern("/auth/permissions"))
		if err != nil {
...
func RegisterPermissionsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PermissionsServiceClient) error {
	mux.Handle(http.MethodGet, pattern_PermissionsService_GetAllPermissions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/some.auth.permissions.PermissionsService/GetAllPermissions", runtime.WithHTTPPathPattern("/auth/permissions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PermissionsService_GetAllPermissions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"auth", "permissions"}, ""))
)
